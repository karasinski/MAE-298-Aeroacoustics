...
\dfrac{d^2 P} {d r^2} + \left \{ \dfrac{1}{r} \right \} \dfrac{d P} {d r} + \left \{ \dfrac{\left ( \omega-k W_{\infty} \right)^2}{\overline{a^2}} -k^2 -\dfrac{n^2}{r^2} \right \} P(r) &= 0 \\
\dfrac{d^2 P} {d r^2} + \left \{ \dfrac{1}{r} \right \} \dfrac{d P} {d r} + \left \{ \lambda_{\infty}^2 -\dfrac{n^2}{r^2} \right \} P(r) &= 0
\end{align*}
where
\begin{align*}
\lambda_{\infty} &= \sqrt{\dfrac{\left ( \omega-k W_{\infty} \right)^2}{\overline{a^2}} -k^2} \\
&= \sqrt{\dfrac{\left ( \omega- \dfrac{w}{\overline{a}} W_{\infty} \right)^2}{\overline{a^2}} -\dfrac{w^2}{\overline{a^2}}} \\
&= \sqrt{\dfrac{\omega^2 \left(1 -\dfrac{W_{\infty}}{\overline{a}} \right)^2}{\overline{a^2}}- \dfrac{\omega^2}{\overline{a^2}}} \\
&= \sqrt{\dfrac{\omega^2}{\overline{a^2}}\left[ \left(1 -M_{\infty} \right)^2 - 1  \right]} \\
&= \sqrt{\dfrac{\omega^2}{\overline{a^2}}\left( 1 -2M_{\infty} + M_{\infty}^2 - 1  \right) } \\
&= \sqrt{\dfrac{\omega^2}{\overline{a^2}}\left( M_{\infty}^2 -2M_{\infty} \right) } \\
&= \sqrt{\dfrac{\omega^2}{\overline{a^2}} M_{\infty}( M_{\infty} - 2 ) } \\
\end{align*}
...
\dfrac{d^2 P} {d r^2} + \left \{ \dfrac{1}{r} \right \} \dfrac{d P} {d r} + \left \{ \lambda_j^2 -\dfrac{n^2}{r^2} \right \} P(r) &= 0
\end{align*}
This ODE can be solved by the following equation
\begin{align*}
P = C J_m (\lambda_j r) + D Y_m (\lambda_j r)
\end{align*}
where $J_m$ and $Y_m$ are the Bessel functions of the first and second kind, respectively, and C and D are unknown constants. The limit
\begin{align*}
\lim_{x\to0} Y_m \to \infty
\end{align*}
however, and so $D=0$ and the general form for the solution is
\begin{align*}
P = C J_m (\lambda_j r)
\end{align*}
...
\end{align*}
Similarly, the velocity normal to the vortex sheet must be equivalent on both sides of the sheet (i.e., $v_r^+ = v_r^-$). Considering the momentum equation
\begin{align*}
\overline{\rho_0} \dfrac{D \vec{v}}{D t} &= - \nabla P
\end{align*}
We define $\vec{v_r} = v e^{-i (w t + k z)}$, where $v$ is an arbitrary constant, and dot both sides normal to the radial direction
\begin{align*}
\overline{\rho_0} \dfrac{D}{D t} \left ( \vec{v} \cdot \hat{r} \right ) &= - \nabla P \cdot \hat{r} \\
\overline{\rho_0} \left( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right) \vec{v_r} &= -\dfrac{d P}{d r} \\
\overline{\rho_0} \left( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right) v e^{-i (w t + k z)} &= -\dfrac{d P}{d r} \\
-i \overline{\rho_0} \left(w - Wk \right) v e^{-i (w t + k z)} &= -\dfrac{d P}{d r} \\
i \overline{\rho_0} \left(w - Wk \right) \vec{v_r} &= \dfrac{d P}{d r}
\end{align*}
Rearranging, and solving for both inside the jet and outside in the freestream, we find
\begin{align}
\vec{v_r}^+ &= \dfrac{\frac{d P}{d r}^+} {i \overline{\rho_0} \left(w - W_{\infty}k \right) } \\
\vec{v_r}^- &= \dfrac{\frac{d P}{d r}^-}{i \overline{\rho_0} \left(w - W_{j}k \right) }
\end{align}
We can define the position of the vortex sheet, $\zeta = \zeta^+ = \zeta^- = \zeta(z, t) = a e^{-i (w t + k z)}$, and
\begin{align*}
...
% \end{align}
% Putting (1) into the momentum equation yields
% \begin{align*}
% \overline{\rho_0} \dfrac{D \vec{v_r}}{D t} &= -\dfrac{\partial P}{\partial r} \\
% \overline{\rho_0} \left( -i a \left( w - W_{\infty} k \right) \zeta \right) \vec{v_r}^+ &= - \dfrac{\partial P}{\partial r} \\
% \overline{\rho_0} i a \left( w - W_{\infty} k \right) \zeta \vec{v_r}^+ &= \dfrac{\partial P}{\partial r}
% \end{align*}
% Rearranging
% \begin{align*}
% \vec{v_r}^+ &= \dfrac{1}{\overline{\rho_0} i a \left( w - W_{\infty} k \right) \zeta } \dfrac{\partial P}{\partial r}^+
% \end{align*}
% We can similarly find
% \begin{align*}
% \vec{v_r}^- &= \dfrac{1}{\overline{\rho_0} i a \left( w - W_{j} k \right) \zeta } \dfrac{\partial P}{\partial r}^-
% \end{align*}
