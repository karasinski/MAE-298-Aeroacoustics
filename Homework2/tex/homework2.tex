...
% The first set of partial derivatives can be expanded as:
% \begin{align*}
% \left ( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right)^3 &=
% \left ( \dfrac{\partial^3}{\partial t^3}
% +3 \dfrac{\partial^2}{\partial t^2} W \dfrac{\partial}{\partial z}
% +3 \dfrac{\partial}{\partial t} W^2 \dfrac{\partial^2}{\partial z^2}
% +W^3 \dfrac{\partial^3}{\partial z^3} \right )\\
% \end{align*}
% We then have
% \begin{align*}
% \left ( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right)^3 p^{\prime} =&
...
% =& \left ( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right)^2 \left ( -i \omega \sol + W ik \sol \right) \\
% =& \left ( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right) (- \omega^2 \sol + 2 W k \omega \sol \\
%                                                                                 & + W^2 k^2 \sol ) \\
% = &+ 2 i W^2 k^2 \omega   \sol
%    +   i         \omega^3 \sol \\
%   &+   i W^3 k^3          \sol
%    - 2 i W   k   \omega^2 \sol \\
%   &+   i W^2 k^2 \omega   \sol
...
%   &+   i W^3 k^3          \sol
%    - 3 i W   k   \omega^2 \sol \\
% = & i \sol \left (\omega^3 + W^2 k^2 \omega - 3 W k \omega^2 + W^3 k^3 \right )
% \end{align*}
%
\begin{align*}
\left ( \dfrac{\partial}{\partial t} + W \dfrac{\partial}{\partial z} \right)^3 p^{\prime} =&
...
% =& -i W k \overline{a^2} \left \{ \left ( -\dfrac{n^2}{r^2} -k^2 \right ) P(r) + \left [ \dfrac{1}{r} \dfrac{d P} {d r} + \dfrac{d^2 P} {d r^2} \right ] \right \} \exp[i(kz+n \theta - \omega t)] \\
% &+ i \omega \overline{a^2} \left \{ \left ( -\dfrac{n^2}{r^2} -k^2 \right ) P(r) + \left [ \dfrac{1}{r} \dfrac{d P} {d r} + \dfrac{d^2 P} {d r^2} \right ] \right \} \exp[i(kz+n \theta - \omega t)] \\
...
&= - \dfrac{d \overline{a^2}}{dr} \left \{ i \left ( W k - \omega \right ) \dfrac{d P}{dr} \right \} \exp[i(kz+n \theta - \omega t)] \\
&= - \dfrac{d \gamma \frac{\overline{p}}{\overline{\rho}}}{dr} \left \{ i \left ( W k - \omega \right ) \dfrac{d P}{dr} \right \} \exp[i(kz+n \theta - \omega t)] \\
&= \gamma \overline{p} \dfrac{d \frac{1}{\overline{\rho}}}{dr} \left \{ i \left ( \omega - W k \right ) \dfrac{d P}{dr} \right \} \exp[i(kz+n \theta - \omega t)] \\
\\
