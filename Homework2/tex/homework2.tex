...
+ \dfrac{1}{\overline{a^2} } \dfrac{d \overline{a^2}}{dr} \left \{ \dfrac{d P}{dr} \right \} \left \{ \dfrac{2 k}{\left ( \omega-k W \right)} \dfrac{dW}{dr} \dfrac{d P}{d r} \right \} &= \dfrac{S(\vec{x}, t)}{i \overline{a^2} \left( \omega - k W \right) \exp[i(kz+n \theta - \omega t)]}
\end{align*}
Rearranging for similar powers of $P$, we have:
\begin{align*}
\dfrac{d^2 P} {d r^2}
+ \left \{ \dfrac{1}{r} + \dfrac{1}{\overline{a^2} } \dfrac{d \overline{a^2}}{dr} + \dfrac{2 k}{\left ( \omega-k W \right)} \dfrac{dW}{dr} \right \} \dfrac{d P} {d r} \\
...
\end{align*}
Finally rearranging one last term:
\begin{align*}
% \overline{a^2} &= \dfrac{\gamma \overline{p}}{\overline{\rho}} \\
% \dfrac{1}{\overline{a^2} } \dfrac{d \overline{a^2}}{dr} & = \dfrac{\overline{\rho}}{\gamma \overline{p}} \dfrac{d }{dr} \dfrac{\gamma \overline{p}}{\overline{\rho}} \\
\dfrac{1}{\overline{a^2} } \dfrac{d \overline{a^2}}{dr} = - \dfrac{1}{\overline{\rho}} \dfrac{d \overline{\rho}}{dr}
% & = \dfrac{1}{\overline{p}} \dfrac{d \overline{p}}{dr}
